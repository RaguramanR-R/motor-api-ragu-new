...
export class findAllClaimss {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllClaimss';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findAllClaimss_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllClaimss');
    //appendnew_flow_findAllClaimss_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllClaimss');

    this.app['post'](
      `${this.serviceBasePath}/dm/claims/claims/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllClaimss_HttpIn
  }
  //   service flows_findAllClaimss

  //appendnew_flow_findAllClaimss_start
  ...
  //appendnew_flow_findAllClaimss_Catch
}
