...
export class updateClaimsById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateClaimsById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_updateClaimsById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateClaimsById');
    //appendnew_flow_updateClaimsById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateClaimsById');

    this.app['post'](
      `${this.serviceBasePath}/dm/claims/claims/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateClaimsById_HttpIn
  }
  //   service flows_updateClaimsById

  //appendnew_flow_updateClaimsById_start
  ...
  //appendnew_flow_updateClaimsById_Catch
}
