...
export class findClaimsById {
  ...
  private constructor(
    ...
    this.serviceName = 'findClaimsById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findClaimsById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findClaimsById');
    //appendnew_flow_findClaimsById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findClaimsById');

    this.app['post'](
      `${this.serviceBasePath}/dm/claims/claims/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findClaimsById_HttpIn
  }
  //   service flows_findClaimsById

  //appendnew_flow_findClaimsById_start
  ...
  //appendnew_flow_findClaimsById_Catch
}
