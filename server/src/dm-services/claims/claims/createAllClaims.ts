...
export class createAllClaims {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllClaims';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createAllClaims_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllClaims');
    //appendnew_flow_createAllClaims_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllClaims');

    this.app['post'](
      `${this.serviceBasePath}/dm/claims/claims/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllClaims_HttpIn
  }
  //   service flows_createAllClaims

  //appendnew_flow_createAllClaims_start
  ...
  //appendnew_flow_createAllClaims_Catch
}
