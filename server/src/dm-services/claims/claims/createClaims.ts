...
export class createClaims {
  ...
  async mountTimers() {
    //appendnew_flow_createClaims_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createClaims');
    //appendnew_flow_createClaims_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createClaims');

    this.app['post'](
      `${this.serviceBasePath}/dm/claims/claims/create`,
      cookieParser(),
    ...
    //appendnew_flow_createClaims_HttpIn
  }
  //   service flows_createClaims

  //appendnew_flow_createClaims_start
  ...
  //appendnew_flow_createClaims_Catch
}
